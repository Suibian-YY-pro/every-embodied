...
conda config --add envs_dirs /root/gpu-freedata/conda_envs
...
echo 'export PYTHONPATH=$PYTHONPATH:/root/gpufree-data/video2robot/third_party/PromptHMR' >> ~/.bashrc
source ~/.bashrc


conda install -c conda-forge eigen -y

# export CPATH="$CONDA_PREFIX/include/eigen3:${CPATH:-}" && cd /root/gpufree-data/video2robot/third_party/PromptHMR/pipeline/droidcalib && python setup.py install
# 编译droidcalib
...
cd /root/gpufree-data/video2robot/third_party/PromptHMR/pipeline/droidcalib
